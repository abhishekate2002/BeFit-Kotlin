...
class ADCW02 : AppCompatActivity() {
    var simpleVideoView: VideoView? = null
    var mediaControls: MediaController? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_adcw02)
        simpleVideoView = findViewById<View>(R.id.chestExerciseVideo1ADCW02) as VideoView
        if (mediaControls == null) {
            ...
            simpleVideoView!!.setVideoURI(
                Uri.parse(
                    ...
                    "android.resource://"
                            + packageName + "/" + R.raw.advance_chest_workout2
                )
            )
            ...
            val chexSubmit = findViewById<Button>(R.id.chexSubmitadcw02)
